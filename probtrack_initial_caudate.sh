        ...
        for side in left right #for each side of the brain
            ...
            for cortical in Executive Motivational Motor #for each cortical region
                ...
                for exclusion in Exclusion No_exclusion;
                    ...
                    mkdir "$DIR/Tractography_${group}/$name/$exclusion/Caudate/$cortical" #folder that will contain probtrackx output of each cortical region of the brain

                    mkdir "$DIR/Tractography_${group}/$name/$exclusion/Caudate/$cortical/$side"  #folder that will contain probtrackx output of each side of the brain
